...
<fmt:message bundle="${loc}" key="local.viewNews.name.edit_button" var="edit_button" />
<fmt:message bundle="${loc}" key="local.viewNews.name.delete_button" var="delete_button" />
<fmt:message bundle="${loc}" key="local.viewNews.name.title" var="news_title" />
...
<fmt:message bundle="${loc}" key="local.viewNews.name.content" var="news_content" />
<fmt:message bundle="${loc}" key="local.viewNews.name.page_title" var="page_title" />
<fmt:message bundle="${loc}" key="local.newsList.name.news" var="news_link" />


<div class="body-title">
	<a href="controller?command=go_to_news_list"><c:out value="${news_link }" /></a> <c:out value="${page_title }" />
</div>
...
<div class="second-view-button">
	<form action="controller" method="post">
		<input type="hidden" name="command" value="go_to_confirmation_page" /> <input
