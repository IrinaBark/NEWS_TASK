...
<fmt:message bundle="${loc}" key="local.newsList.name.newsList" var="newsList" />
<fmt:message bundle="${loc}" key="local.newsList.name.editLink" var="editLink" />
<fmt:message bundle="${loc}" key="local.newsList.name.viewLink" var="viewLink" />
<fmt:message bundle="${loc}" key="local.newsList.name.delete_button" var="delete_button" />


<div class="body-title">
	<a href="controller?command=go_to_news_list"><c:out value="${news}" /> </a> <c:out value="${newsList}" />
</div>
